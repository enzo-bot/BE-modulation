...
class Eli(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "observation_spectre1")
        ...
        self._cf_range_win = RangeWidget(self._cf_range_range, self.set_cf_range, 'cf_range', "counter_slider", float)
        self.top_grid_layout.addWidget(self._cf_range_win)
        self._bw_range_range = Range(0, 100000000, 1000000, 10000000, 200)
        self._bw_range_win = RangeWidget(self._bw_range_range, self.set_bw_range, 'bw_range', "counter_slider", float)
        self.top_grid_layout.addWidget(self._bw_range_win)
        ...
        self.uhd_usrp_source_0.set_samp_rate(bw_range)
    ...
    def set_bw_range(self, bw_range):
        ...
        self.qtgui_sink_x_0.set_frequency_range(self.cf_range, self.bw_range)
        self.uhd_usrp_source_0.set_samp_rate(self.bw_range)
