...
class observation_spectre(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "observation_spectre")
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 700000
        self.center_freq = center_freq = 330000000

        ##################################################
        # Blocks
        ##################################################

        self._center_freq_range = Range(100000000, 6000000000, 100000000, 330000000, 200)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 125000, 12500, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=observation_spectre, options=None):
